package com.fiche.patient.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.fiche.patient.service.EmailAlreadyUsedException ||
            ex instanceof com.fiche.patient.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.fiche.patient.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.fiche.patient");
    }
}
