...
class ServiceResourceIT {
    ...
    public static Service createEntity(EntityManager em) {
        Service service = new Service().nomS(DEFAULT_NOM_S).description(DEFAULT_DESCRIPTION);
        return service;
    }
    ...
    public static Service createUpdatedEntity(EntityManager em) {
        Service service = new Service().nomS(UPDATED_NOM_S).description(UPDATED_DESCRIPTION);
        return service;
    }
    ...
    @Test
    @Transactional
    void checkNomSIsRequired() throws Exception {
        int databaseSizeBeforeTest = serviceRepository.findAll().size();
        // set the field null
        service.setNomS(null);
    ...
    void putExistingService() throws Exception {
        ...
        updatedService.nomS(UPDATED_NOM_S).description(UPDATED_DESCRIPTION);
